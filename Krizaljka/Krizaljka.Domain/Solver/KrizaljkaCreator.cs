...
{   
    ...
    {
        if (!theKrizaljka.NeighborSlotsIdsBySlotId.TryGetValue(placedSlot.Id, out var neighborSlotIds))
        {
            return 0;
        }
        ...
        foreach (var neighborSlotId in neighborSlotIds)
        {
            ...
            var fittingCount = GetFittingCount(neighborSlot);
