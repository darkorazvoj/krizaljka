...
while (true)
{
    ...
    switch (where)
    {
        case "d":
            ...
            var options1 = new JsonSerializerOptions { WriteIndented = true, Encoder = JavaScriptEncoder.Create(UnicodeRanges.All), };
        ...
        case "l":
            ...
            while (true)
            {
                ...
                var denseSearchTerm =
                    string.IsNullOrWhiteSpace(searchTerm) ? searchTerm : searchTerm.RemoveWhiteSpaces().ToUpperInvariant();
    ...
    //        var denseSearchTerm = string.IsNullOrWhiteSpace(searchTerm) ? searchTerm : searchTerm.RemoveWhiteSpaces();
    ...
    //        foreach (var validTerm in result)
    //        {
    //            Console.WriteLine(validTerm.RawValue);
    //        }
